...
class Zefoy:
	...
	def __init__(self):
		...
		self.url = 'None'
		self.text = 'LÂM TILO'
		url1=input("Your TikTok Video Link: ")
		self.url=url1
...
def logo():
    ...
    {tim} ███████╗██║░░██║██║░╚═╝░██║  ░░░██║░░░██║███████╗╚█████╔╝
    {dac_biet} ╚══════╝╚═╝░░╚═╝╚═╝░░░░░╚═╝  ░░░╚═╝░░░╚═╝╚══════╝░╚════╝░
    {xanh_la} </> Made By Sakib King
    \033[1;37m────────────────────────────────────────────────────────────
    {do}[{trang}{kt_code}{do}] {vang}TIKTOK VIEW HACK 
    {do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36m SAKIB
    {do}[{trang}{kt_code}{do}] \033[1;31mNumber: \033[1;33m +8801892098111
    {do}[{trang}{kt_code}{do}] {dac_biet}YOUTUBE:\033[1;37m No
    {do}[{trang}{kt_code}{do}] {xanh_la}FACEBOOK:\033[1;37m Sakib Hassan
    \033[1;37m────────────────────────────────────────────────────────────\n"""
